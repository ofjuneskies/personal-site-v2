<div class="exp">
    ...
    <a class="title" href="https://github.com/ofjuneskies/personal-site-v2" target="_blank" rel="noopener noreferrer">personal site ⮵</a>
        <p class="subtitle">
            <i>this site!</i>
    ...
    <a class="title" href="https://github.com/hits-sdo/hits-sdo-similaritysearch" target="_blank" rel="noopener noreferrer">hits-sdo ⮵</a>
        <p class="subtitle">
            ...
            <br>python, pytorch lightning, jupyter notebooks, skikit-learn, numpy, lightly
        </p>
